...
export const ValuesSection = () => {
  return (
    <div className="relative z-10 mt-10">
        <div
        className="relative -z-20 bg-cover bg-center bg-no-repeat text-white flex flex-col items-center justify-center gap-8 px-10 pt-32 pb-5"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className='flex items-center justify-center mb-10'><p className='text-white border-b-2 text-3xl border-[#D7B56D] font-bold'>Vision, Mission, and Core Values</p></div>
        ...
        <div className='px-64'>
            ...
            <div className='flex flex-col gap-6'>
                <p className='font-semibold text-lg border-b-2 border-[#D7B56D] max-w-fit'>Vision</p>
                <p>Affecting lives through the Word, prayer, and love to enter into God's dominion mandate, who also in turn will affect their generation.</p>
            </div>
...
{/* Mission */}
            <div>
            <div className='flex flex-col gap-6'>
                <p className='font-semibold text-lg'><span className='border-b-2 border-[#D7B56D]'>Mission</span></p>
                <p className=''>Raising people that are bold and courageous to exhibit their dominion mandate in all spheres of life.</p>
            </div>
            ...
            <div>
            <div className='flex flex-col gap-6'>
                <p className='font-semibold text-lg border-b-2 border-[#D7B56D] max-w-fit'>Core Values</p>
